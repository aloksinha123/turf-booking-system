      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        ...
        {viewMode === 'grid' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div 
              onClick={() => handleTurfSelect(3)}
              className={`p-6 rounded-3xl border transition-all cursor-pointer ${selectedTurf === '3' ? 'bg-slate-900/60 border-slate-800 hover:border-slate-700'}`}
            >
              <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h3 className="text-xl font-black uppercase tracking-tight flex items-center gap-2">
                ...
                {activeTab === 'premium' ? 'Available Standard Slots' : 'Join Matchmaking Sessions'}
              </h3>
                  ...
                  >
                    ...
                    <div className="mt-8 pt-5 border-t border-slate-800/80 flex items-end justify-between">
                      <div>
                        ...
                        <p className={`text-2xl font-black ${isPeak ? 'text-purple-400' : 'text-emerald-400'}`}>
                          ₹{activeTab === 'matchmaking' ? (slot.base_price / slot.required_players).toFixed(2) : slot.base_price}
                        </p>
